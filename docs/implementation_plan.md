...
#### [NEW] pkg/excel/excelize_client.go
...
#### [MODIFY] internal/services/excel/service.go
...
#### [NEW] internal/app/upload_handlers.go
...
#### [NEW] frontend/src/components/UploadExcel.tsx
...
#### [NEW] frontend/src/components/ExcelViewer.tsx
...
#### [MODIFY] internal/services/chat/executor.go
...
2. **Teste de Integração Existente (Adaptado)**
   ...
   ```
   - Modificar `integration_test.go` para usar flag `--mode=excelize`
